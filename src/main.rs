...
fn main() -> ! {
    ...
    unsafe {
        // tg0 wdg
        core::ptr::write_volatile(0x6001f064 as *mut _, 0x50D83AA1);
        core::ptr::write_volatile(0x6001F048 as *mut _, 0);

        // tg1 wdg
        core::ptr::write_volatile(0x60020064 as *mut _, 0x50D83AA1);
        core::ptr::write_volatile(0x60020048 as *mut _, 0);

        // rtc wdg
        core::ptr::write_volatile(0x600080a8 as *mut _, 0x50D83AA1);
